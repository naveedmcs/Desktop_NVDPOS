...
namespace iTalk
{
    ...
    class iTalk_TextBox_Small : Control
    {
        ...
        public void AddTextBox()
        {
            ...
            _TB.Text = string.Empty;
            _TB.BackColor = Color.FromArgb(66, 76, 85); // TextBoxcustomBackColor added 
            _TB.BorderStyle = BorderStyle.None;
            _TB.TextAlign = HorizontalAlignment.Left;
            _TB.Font = new Font("Tahoma", 11);
            _TB.UseSystemPasswordChar = UseSystemPasswordChar;
        ...
        public iTalk_TextBox_Small()
        {
            ...
            P1 = new Pen(Color.FromArgb(66, 76, 85)); // P1 = Border color
            B1 = new SolidBrush(Color.FromArgb(66, 76, 85)); // B1 = Rect Background color
            BackColor = Color.Transparent;
    ...
    class iTalk_TabControl : TabControl
    {
        ...
        public iTalk_TabControl()
        {
            ...
            {
                Page.BackColor = Color.FromArgb(26, 26, 26);
            }
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            var _Graphics = G;
            // tab rectangle border color
            _Graphics.Clear(Color.FromArgb(255, 255, 255));
